  ...
  exercises: [
    ...
    },
    {
      ...
      questions: [
        ...
        { sentence: "'Why are you late?' he asked. → He asked why I ___ late.", answer: "was", options: ["was", "am", "were"], explanation: "Reported question: statement word order, present backshifts to past.", explanationI18n: { fr: "Question rapportée : ordre de la phrase déclarative, le présent recule au passé.", es: "Pregunta citada: orden de oración afirmativa, el presente retrocede al pasado.", pt: "Pergunta citada: ordem de frase afirmativa, o presente recua para o passado.", it: "Domanda riportata: ordine della frase affermativa, il presente arretra al passato.", de: "Berichtete Frage: Aussagesatz-Wortstellung, das Präsens rückt in die Vergangenheit zurück.", ru: "Косвенный вопрос: порядок слов утверждения, настоящее сдвигается в прошедшее.", ar: "سؤال منقول: ترتيب الجملة الخبرية، ويتراجع المضارع إلى الماضي.", zh: "间接疑问句:陈述句语序,现在时后移为过去时。" } },
        { sentence: "'Did you finish the report?' she asked. → She asked ___ I had finished the report.", answer: "if", options: ["if", "that", "when"], explanation: "Yes/no question reported with if/whether; past simple backshifts to past perfect.", explanationI18n: { fr: "Question fermée rapportée avec if/whether ; le past simple recule au past perfect.", es: "Pregunta de sí/no citada con if/whether; el past simple retrocede al past perfect.", pt: "Pergunta de sim/não citada com if/whether; o past simple recua para o past perfect.", it: "Domanda sì/no riportata con if/whether; il past simple arretra al past perfect.", de: "Ja/Nein-Frage mit if/whether wiedergegeben; das past simple rückt zum past perfect zurück.", ru: "Общий вопрос передаётся через if/whether; past simple сдвигается в past perfect.", ar: "سؤال نعم/لا يُنقل بـ if/whether؛ ويتراجع past simple إلى past perfect.", zh: "是/否疑问句用 if/whether 转述;past simple 后移为 past perfect。" } },
        { sentence: "He denied that he ___ (break) the window.", answer: "had broken", options: ["had broken", "broke", "has broken"], explanation: "deny + that + subject + backshifted past perfect (broke → had broken).", explanationI18n: { fr: "deny + that + sujet + past perfect reculé (broke → had broken).", es: "deny + that + sujeto + past perfect retrocedido (broke → had broken).", pt: "deny + that + sujeito + past perfect recuado (broke → had broken).", it: "deny + that + soggetto + past perfect arretrato (broke → had broken).", de: "deny + that + Subjekt + zurückverschobenes past perfect (broke → had broken).", ru: "deny + that + подлежащее + сдвинутое past perfect (broke → had broken).", ar: "deny + that + فاعل + past perfect متراجع (broke ← had broken).", zh: "deny + that + 主语 + 后移的 past perfect(broke → had broken)。" } },
      ],
    },
  ],
};
