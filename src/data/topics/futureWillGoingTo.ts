...
export const futureWillGoingTo: GrammarTopicContent = {
  ...
  explanations: {
    en: [
      ...
      "Form: will + base verb — will is a modal, so it never changes for any subject and never uses do: she will come, not she wills come; won't for the negative. Going to: am/is/are + going to + base verb, so the be-verb still agrees with the subject: I'm going to leave; he's going to call. Negatives add not to be (I'm not going to leave). Questions invert be and the subject (is he going to call?).",
      {
        ...
        items: [
          "Spontaneous decision (will): the phone's ringing — I'll get it! (decided right now)",
          "Prior plan (going to): I'm going to start a new job next month (already arranged)",
          "Opinion-based prediction (will): I think the team will win (belief, no proof)",
    ...
    fr: [
      ...
      "Formation : will + verbe de base — will est un modal, il ne change donc jamais selon le sujet et n'emploie jamais do : she will come, et non she wills come ; won't à la forme négative. Going to : am/is/are + going to + verbe de base, où be s'accorde toujours avec le sujet : I'm going to leave ; he's going to call. À la forme négative, not se place après be (I'm not going to leave). À la forme interrogative, on inverse be et le sujet (is he going to call ?).",
      {
        ...
        items: [
          "Décision spontanée (will) : the phone's ringing — I'll get it! (décidé sur l'instant)",
          "Projet déjà décidé (going to) : I'm going to start a new job next month (déjà prévu)",
          "Prédiction fondée sur une opinion (will) : I think the team will win (croyance, sans preuve)",
    ...
    es: [
      ...
      "Forma: will + verbo base — will es un modal, así que nunca cambia según el sujeto ni usa do: she will come, no she wills come; won't en negativo. Going to: am/is/are + going to + verbo base, donde be sigue concordando con el sujeto: I'm going to leave; he's going to call. En negativo, not se coloca tras be (I'm not going to leave). En preguntas se invierten be y el sujeto (is he going to call?).",
      {
        ...
        items: [
          "Decisión espontánea (will): the phone's ringing — I'll get it! (decidido en ese momento)",
          "Plan ya decidido (going to): I'm going to start a new job next month (ya organizado)",
          "Predicción basada en opinión (will): I think the team will win (creencia, sin pruebas)",
    ...
    pt: [
      ...
      "Forma: will + verbo base — will é um modal, por isso nunca muda consoante o sujeito nem usa do: she will come, e não she wills come; won't na negativa. Going to: am/is/are + going to + verbo base, em que be continua a concordar com o sujeito: I'm going to leave; he's going to call. Na negativa, not fica depois de be (I'm not going to leave). Nas perguntas invertem-se be e o sujeito (is he going to call?).",
      {
        ...
        items: [
          "Decisão espontânea (will): the phone's ringing — I'll get it! (decidido naquele momento)",
          "Plano já decidido (going to): I'm going to start a new job next month (já combinado)",
          "Previsão baseada em opinião (will): I think the team will win (crença, sem provas)",
    ...
    it: [
      ...
      "Forma: will + verbo base — will è un modale, quindi non cambia mai in base al soggetto e non usa mai do: she will come, non she wills come; won't al negativo. Going to: am/is/are + going to + verbo base, dove be concorda comunque con il soggetto: I'm going to leave; he's going to call. Al negativo, not si mette dopo be (I'm not going to leave). Nelle domande si invertono be e il soggetto (is he going to call?).",
      {
        ...
        items: [
          "Decisione spontanea (will): the phone's ringing — I'll get it! (deciso sul momento)",
          "Piano già deciso (going to): I'm going to start a new job next month (già organizzato)",
          "Previsione basata sull'opinione (will): I think the team will win (convinzione, senza prove)",
    ...
    de: [
      ...
      "Form: will + Grundform — will ist ein Modalverb, ändert sich also nie je nach Subjekt und benutzt nie do: she will come, nicht she wills come; won't in der Verneinung. Going to: am/is/are + going to + Grundform, wobei be weiterhin mit dem Subjekt übereinstimmt: I'm going to leave; he's going to call. Bei der Verneinung steht not nach be (I'm not going to leave). Bei Fragen werden be und das Subjekt vertauscht (is he going to call?).",
      {
        ...
        items: [
          "Spontane Entscheidung (will): the phone's ringing — I'll get it! (im Moment entschieden)",
          "Vorher feststehender Plan (going to): I'm going to start a new job next month (bereits vereinbart)",
          "Meinungsbasierte Vorhersage (will): I think the team will win (Überzeugung, kein Beweis)",
    ...
    ru: [
      ...
      "Форма: will + базовая форма глагола — will является модальным глаголом, поэтому никогда не меняется в зависимости от подлежащего и никогда не использует do: she will come, а не she wills come; won't в отрицании. Going to: am/is/are + going to + базовая форма, где be по-прежнему согласуется с подлежащим: I'm going to leave; he's going to call. В отрицании not ставится после be (I'm not going to leave). В вопросах местами меняются be и подлежащее (is he going to call?).",
      {
        ...
        items: [
          "Спонтанное решение (will): the phone's ringing — I'll get it! (решено прямо сейчас)",
          "Заранее решённый план (going to): I'm going to start a new job next month (уже договорено)",
          "Предсказание на основе мнения (will): I think the team will win (убеждение, без доказательств)",
    ...
    ar: [
      ...
      "الصيغة: will + الفعل الأساسي — will فعل ناقص، لذا لا يتغيّر أبدًا حسب الفاعل ولا يستخدم do أبدًا: she will come، وليس she wills come؛ won't في النفي. going to: am/is/are + going to + الفعل الأساسي، حيث يظل الفعل be متوافقًا مع الفاعل: I'm going to leave؛ he's going to call. في النفي توضع not بعد be (I'm not going to leave). وفي السؤال يتبادل be والفاعل مكانيهما (is he going to call؟).",
      {
        ...
        items: [
          "قرار عفوي (will): the phone's ringing — I'll get it! (تقرر في اللحظة نفسها)",
          "خطة مُقرَّرة مسبقًا (going to): I'm going to start a new job next month (متفق عليه مسبقًا)",
          "تنبؤ مبني على رأي (will): I think the team will win (اعتقاد، بلا دليل)",
    ...
    zh: [
      ...
      "构成:will + 动词原形——will 是情态动词,因此从不随主语变化,也从不用 do:she will come,而不是 she wills come;否定式用 won't。going to:am/is/are + going to + 动词原形,其中 be 动词仍要与主语保持一致:I'm going to leave;he's going to call。否定式把 not 放在 be 后面(I'm not going to leave)。疑问句中 be 与主语互换位置(is he going to call?)。",
      {
        ...
        items: [
          "临时决定(will):the phone's ringing — I'll get it!(当场决定)",
          "事先计划好的(going to):I'm going to start a new job next month(已经安排好)",
          "基于看法的预测(will):I think the team will win(个人相信,没有证据)",
  ...
  exercises: [
    {
      title: "Spontaneous vs Planned",
      questions: [
        { sentence: "The phone's ringing — I ___ (get) it!", answer: "'ll get", options: ["'ll get", "'m going to get", "get"], explanation: "A spontaneous decision made right now → will.", explanationI18n: { fr: "Une décision spontanée prise à l'instant → will.", es: "Una decisión espontánea tomada en este momento → will.", pt: "Uma decisão espontânea tomada agora mesmo → will.", it: "Una decisione spontanea presa proprio ora → will.", de: "Eine spontane Entscheidung, die gerade jetzt getroffen wird → will.", ru: "Спонтанное решение, принятое прямо сейчас → will.", ar: "قرار عفوي يُتخذ الآن → will.", zh: "此刻当场做出的临时决定 → will。" } },
        { sentence: "We ___ (move) to Berlin next year — we've already decided.", answer: "'re going to move", options: ["'re going to move", "'ll move", "'s going to move"], explanation: "An already-decided plan → going to; we → 're (are), not 's (is).", explanationI18n: { fr: "Un projet déjà décidé → going to ; we → 're (are), pas 's (is).", es: "Un plan ya decidido → going to; we → 're (are), no 's (is).", pt: "Um plano já decidido → going to; we → 're (are), não 's (is).", it: "Un piano già deciso → going to; we → 're (are), non 's (is).", de: "Ein bereits feststehender Plan → going to; we → 're (are), nicht 's (is).", ru: "Уже принятый план → going to; we → 're (are), а не 's (is).", ar: "خطة تم تحديدها مسبقاً → going to؛ we → 're (are)، وليس 's (is).", zh: "已经决定好的计划 → going to;we 用 're (are),不用 's (is)。" } },
        { sentence: "A: I'm cold. B: I ___ (turn on) the heater.", answer: "'ll turn on", options: ["'ll turn on", "'m going to turn on", "turn on"], explanation: "A spontaneous offer decided at the moment of speaking → will.", explanationI18n: { fr: "Une offre spontanée décidée au moment de parler → will.", es: "Un ofrecimiento espontáneo decidido en el momento de hablar → will.", pt: "Uma oferta espontânea decidida no momento da fala → will.", it: "Un'offerta spontanea decisa nel momento in cui si parla → will.", de: "Ein spontanes Angebot, das im Moment des Sprechens entschieden wird → will.", ru: "Спонтанное предложение, принятое в момент речи → will.", ar: "عرض عفوي يُقرَّر لحظة الكلام → will.", zh: "说话当下临时提出的主动提议 → will。" } },
        { sentence: "She ___ (start) a new job next month — it's all arranged.", answer: "'s going to start", options: ["'s going to start", "'ll start", "'re going to start"], explanation: "An already-arranged plan → going to; she → 's (is), not 're (are).", explanationI18n: { fr: "Un projet déjà organisé → going to ; she → 's (is), pas 're (are).", es: "Un plan ya organizado → going to; she → 's (is), no 're (are).", pt: "Um plano já combinado → going to; she → 's (is), não 're (are).", it: "Un piano già organizzato → going to; she → 's (is), non 're (are).", de: "Ein bereits arrangierter Plan → going to; she → 's (is), nicht 're (are).", ru: "Уже согласованный план → going to; she → 's (is), а не 're (are).", ar: "خطة مُرتَّبة مسبقاً → going to؛ she → 's (is)، وليس 're (are).", zh: "已经安排好的计划 → going to;she 用 's (is),不用 're (are)。" } },
        { sentence: "I think it ___ (be) sunny tomorrow.", answer: "will be", options: ["will be", "is going to be", "is being"], explanation: "An opinion/belief with no visible evidence → will.", explanationI18n: { fr: "Une opinion/croyance sans preuve visible → will.", es: "Una opinión/creencia sin evidencia visible → will.", pt: "Uma opinião/crença sem evidência visível → will.", it: "Un'opinione/convinzione senza prove visibili → will.", de: "Eine Meinung/Überzeugung ohne sichtbaren Beweis → will.", ru: "Мнение/убеждение без видимых доказательств → will.", ar: "رأي/اعتقاد دون دليل ملموس → will.", zh: "没有明显证据支持的看法/推测 → will。" } },
        { sentence: "Look at those dark clouds — it ___ (rain).", answer: "'s going to rain", options: ["'s going to rain", "'ll rain", "'re going to rain"], explanation: "A prediction based on visible evidence right now → going to.", explanationI18n: { fr: "Une prédiction fondée sur une preuve visible en ce moment → going to.", es: "Una predicción basada en evidencia visible en este momento → going to.", pt: "Uma previsão baseada em evidência visível neste momento → going to.", it: "Una previsione basata su prove visibili in questo momento → going to.", de: "Eine Vorhersage, die auf einem gerade sichtbaren Beweis beruht → going to.", ru: "Прогноз на основе видимого прямо сейчас доказательства → going to.", ar: "تنبؤ مبني على دليل ملموس الآن → going to.", zh: "根据当下可见证据做出的预测 → going to。" } },
        { sentence: "Someone's knocking at the door — I ___ (answer) it.", answer: "'ll answer", options: ["'ll answer", "'m going to answer", "answer"], explanation: "A spontaneous decision made at the moment of speaking → will.", explanationI18n: { fr: "Une décision spontanée prise au moment de parler → will.", es: "Una decisión espontánea tomada en el momento de hablar → will.", pt: "Uma decisão espontânea tomada no momento da fala → will.", it: "Una decisione spontanea presa nel momento in cui si parla → will.", de: "Eine spontane Entscheidung, die im Moment des Sprechens getroffen wird → will.", ru: "Спонтанное решение, принятое в момент речи → will.", ar: "قرار عفوي يُتخذ لحظة الكلام → will.", zh: "说话当下做出的临时决定 → will。" } },
        { sentence: "They ___ (get married) in June — they've already booked the venue.", answer: "'re going to get married", options: ["'re going to get married", "'ll get married", "'s going to get married"], explanation: "An already-arranged plan → going to; they → 're (are), not 's (is).", explanationI18n: { fr: "Un projet déjà organisé → going to ; they → 're (are), pas 's (is).", es: "Un plan ya organizado → going to; they → 're (are), no 's (is).", pt: "Um plano já combinado → going to; they → 're (are), não 's (is).", it: "Un piano già organizzato → going to; they → 're (are), non 's (is).", de: "Ein bereits arrangierter Plan → going to; they → 're (are), nicht 's (is).", ru: "Уже согласованный план → going to; they → 're (are), а не 's (is).", ar: "خطة مُرتَّبة مسبقاً → going to؛ they → 're (are)، وليس 's (is).", zh: "已经安排好的计划 → going to;they 用 're (are),不用 's (is)。" } },
        { sentence: "Watch out — you ___ (fall)!", answer: "'re going to fall", options: ["'re going to fall", "'ll fall", "'s going to fall"], explanation: "Imminent, visible evidence right now → going to; you → 're (are).", explanationI18n: { fr: "Preuve visible et imminente en ce moment → going to ; you → 're (are).", es: "Evidencia visible e inminente en este momento → going to; you → 're (are).", pt: "Evidência visível e iminente neste momento → going to; you → 're (are).", it: "Prova visibile e imminente in questo momento → going to; you → 're (are).", de: "Unmittelbar bevorstehendes, gerade sichtbares Ereignis → going to; you → 're (are).", ru: "Неминуемое, видимое прямо сейчас доказательство → going to; you → 're (are).", ar: "دليل ملموس ووشيك الحدوث الآن → going to؛ you → 're (are).", zh: "此刻迫在眉睫、有明显证据的情况 → going to;you 用 're (are)。" } },
        { sentence: "I promise I ___ (call) you as soon as I land.", answer: "will call", options: ["will call", "am going to call", "call"], explanation: "A promise → will.", explanationI18n: { fr: "Une promesse → will.", es: "Una promesa → will.", pt: "Uma promessa → will.", it: "Una promessa → will.", de: "Ein Versprechen → will.", ru: "Обещание → will.", ar: "وعد → will.", zh: "承诺 → will。" } },
      ],
    },
    {
      title: "Predictions & Mixed Practice",
      questions: [
        { sentence: "I'm sure she ___ (win) — she's the best player.", answer: "will win", options: ["will win", "is going to win", "wins"], explanation: "An opinion/belief, not something you can see happening → will.", explanationI18n: { fr: "Une opinion/croyance, pas quelque chose qu'on voit se produire → will.", es: "Una opinión/creencia, no algo que se pueda ver ocurriendo → will.", pt: "Uma opinião/crença, não algo que se possa ver acontecendo → will.", it: "Un'opinione/convinzione, non qualcosa che si vede accadere → will.", de: "Eine Meinung/Überzeugung, kein sichtbar ablaufendes Ereignis → will.", ru: "Мнение/убеждение, а не то, что видно происходящим → will.", ar: "رأي/اعتقاد، وليس أمراً يمكن رؤيته يحدث → will.", zh: "看法/推测,而不是能看到正在发生的事 → will。" } },
        { sentence: "Look — the sky is clearing up. It ___ (be) a nice day.", answer: "'s going to be", options: ["'s going to be", "'ll be", "'re going to be"], explanation: "Visible evidence right now → going to; it → 's (is).", explanationI18n: { fr: "Preuve visible en ce moment → going to ; it → 's (is).", es: "Evidencia visible en este momento → going to; it → 's (is).", pt: "Evidência visível neste momento → going to; it → 's (is).", it: "Prova visibile in questo momento → going to; it → 's (is).", de: "Gerade sichtbarer Beweis → going to; it → 's (is).", ru: "Видимое прямо сейчас доказательство → going to; it → 's (is).", ar: "دليل ملموس الآن → going to؛ it → 's (is).", zh: "当下可见的证据 → going to;it 用 's (is)。" } },
        { sentence: "A: We need milk. B: OK, I ___ (buy) some when I go out.", answer: "'ll buy", options: ["'ll buy", "'m going to buy", "buy"], explanation: "A decision made right at the moment of speaking → will.", explanationI18n: { fr: "Une décision prise à l'instant même où l'on parle → will.", es: "Una decisión tomada justo en el momento de hablar → will.", pt: "Uma decisão tomada bem no momento da fala → will.", it: "Una decisione presa proprio nel momento in cui si parla → will.", de: "Eine Entscheidung, die genau im Moment des Sprechens getroffen wird → will.", ru: "Решение, принятое прямо в момент речи → will.", ar: "قرار يُتخذ في لحظة الكلام تحديداً → will.", zh: "正是说话那一刻做出的决定 → will。" } },
        { sentence: "We ___ (meet) Sarah for lunch tomorrow — it's already in the calendar.", answer: "'re going to meet", options: ["'re going to meet", "'ll meet", "'s going to meet"], explanation: "An already-arranged plan → going to; we → 're (are).", explanationI18n: { fr: "Un projet déjà organisé → going to ; we → 're (are).", es: "Un plan ya organizado → going to; we → 're (are).", pt: "Um plano já combinado → going to; we → 're (are).", it: "Un piano già organizzato → going to; we → 're (are).", de: "Ein bereits arrangierter Plan → going to; we → 're (are).", ru: "Уже согласованный план → going to; we → 're (are).", ar: "خطة مُرتَّبة مسبقاً → going to؛ we → 're (are).", zh: "已经安排好的计划 → going to;we 用 're (are)。" } },
        { sentence: "I think prices ___ (rise) next year.", answer: "will rise", options: ["will rise", "are going to rise", "rise"], explanation: "An opinion about the future → will.", explanationI18n: { fr: "Une opinion sur l'avenir → will.", es: "Una opinión sobre el futuro → will.", pt: "Uma opinião sobre o futuro → will.", it: "Un'opinione sul futuro → will.", de: "Eine Meinung über die Zukunft → will.", ru: "Мнение о будущем → will.", ar: "رأي حول المستقبل → will.", zh: "对未来的看法 → will。" } },
        { sentence: "She's five months pregnant — she ___ (have) a baby in the spring.", answer: "'s going to have", options: ["'s going to have", "'ll have", "'re going to have"], explanation: "A prediction based on clear present evidence → going to; she → 's (is).", explanationI18n: { fr: "Une prédiction fondée sur une preuve actuelle claire → going to ; she → 's (is).", es: "Una predicción basada en evidencia presente clara → going to; she → 's (is).", pt: "Uma previsão baseada em evidência presente clara → going to; she → 's (is).", it: "Una previsione basata su una chiara prova presente → going to; she → 's (is).", de: "Eine Vorhersage, die auf einem klaren gegenwärtigen Beweis beruht → going to; she → 's (is).", ru: "Прогноз на основе явного доказательства в настоящем → going to; she → 's (is).", ar: "تنبؤ مبني على دليل حالي واضح → going to؛ she → 's (is).", zh: "根据当前明显证据做出的预测 → going to;she 用 's (is)。" } },
        { sentence: "I promise I ___ (not/tell) anyone your secret.", answer: "won't tell", options: ["won't tell", "'m not going to tell", "don't tell"], explanation: "A promise → will (negative: won't).", explanationI18n: { fr: "Une promesse → will (négatif : won't).", es: "Una promesa → will (negativo: won't).", pt: "Uma promessa → will (negativo: won't).", it: "Una promessa → will (negativo: won't).", de: "Ein Versprechen → will (Verneinung: won't).", ru: "Обещание → will (отрицание: won't).", ar: "وعد → will (صيغة النفي: won't).", zh: "承诺 → will(否定式:won't)。" } },
        { sentence: "He's packed his bags and booked the flight — he ___ (leave) tomorrow.", answer: "'s going to leave", options: ["'s going to leave", "'ll leave", "'re going to leave"], explanation: "Already arranged (evidence + plan) → going to; he → 's (is).", explanationI18n: { fr: "Déjà organisé (preuve + projet) → going to ; he → 's (is).", es: "Ya organizado (evidencia + plan) → going to; he → 's (is).", pt: "Já combinado (evidência + plano) → going to; he → 's (is).", it: "Già organizzato (prova + piano) → going to; he → 's (is).", de: "Bereits arrangiert (Beweis + Plan) → going to; he → 's (is).", ru: "Уже согласовано (доказательство + план) → going to; he → 's (is).", ar: "مُرتَّب مسبقاً (دليل + خطة) → going to؛ he → 's (is).", zh: "已经安排好(既有证据又有计划) → going to;he 用 's (is)。" } },
        { sentence: "Don't worry, I ___ (help) you carry that.", answer: "'ll help", options: ["'ll help", "'m going to help", "help"], explanation: "A spontaneous offer → will.", explanationI18n: { fr: "Une offre spontanée → will.", es: "Un ofrecimiento espontáneo → will.", pt: "Uma oferta espontânea → will.", it: "Un'offerta spontanea → will.", de: "Ein spontanes Angebot → will.", ru: "Спонтанное предложение (помощи) → will.", ar: "عرض عفوي → will.", zh: "临时主动提议 → will。" } },
        { sentence: "Careful — that glass ___ (fall) off the table!", answer: "'s going to fall", options: ["'s going to fall", "'ll fall", "'re going to fall"], explanation: "Imminent, visible evidence → going to; that glass = it → 's (is).", explanationI18n: { fr: "Preuve visible et imminente → going to ; that glass = it → 's (is).", es: "Evidencia visible e inminente → going to; that glass = it → 's (is).", pt: "Evidência visível e iminente → going to; that glass = it → 's (is).", it: "Prova visibile e imminente → going to; that glass = it → 's (is).", de: "Unmittelbar bevorstehender, sichtbarer Beweis → going to; that glass = it → 's (is).", ru: "Неминуемое, видимое доказательство → going to; that glass = it → 's (is).", ar: "دليل ملموس ووشيك → going to؛ that glass = it → 's (is).", zh: "迫在眉睫、显而易见的证据 → going to;that glass = it,用 's (is)。" } },
      ],
    },
  ],
};
