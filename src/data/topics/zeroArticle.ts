...
export const zeroArticle: GrammarTopicContent = {
  slug: "zero-article",
  ...
  explanations: {
    en: [
      "Use no article — called the 'zero article' — for general statements with plural or uncountable nouns: I like cats (cats in general), not I like the cats; water is essential for life (water in general, not a specific glass of it). This contrasts with a/an (one example) and the (a specific, known one) — zero article talks about a whole category, not one member of it.",
      {
    ...
    fr: [
      "Utilisez l'absence d'article — appelée « zero article » — pour les déclarations générales avec un nom pluriel ou indénombrable : I like cats (les chats en général), et non I like the cats ; water is essential for life (l'eau en général, pas un verre précis). Cela s'oppose à a/an (un exemple) et à the (un élément précis et connu) — le zero article parle de toute une catégorie, pas d'un seul élément de cette catégorie.",
      {
    ...
    es: [
      "Usa la ausencia de artículo — llamada «zero article» — para afirmaciones generales con un sustantivo plural o incontable: I like cats (los gatos en general), no I like the cats; water is essential for life (el agua en general, no un vaso concreto). Esto contrasta con a/an (un ejemplo) y con the (uno concreto y conocido) — el zero article habla de toda una categoría, no de un solo miembro de ella.",
      {
    ...
    pt: [
      "Usa a ausência de artigo — chamada «zero article» — para afirmações gerais com um substantivo plural ou incontável: I like cats (gatos em geral), e não I like the cats; water is essential for life (água em geral, não um copo específico). Isto contrasta com a/an (um exemplo) e com the (um específico e já conhecido) — o zero article fala de toda uma categoria, não de um único membro dela.",
      {
    ...
    it: [
      "Usa l'assenza di articolo — chiamata «zero article» — per affermazioni generali con un nome plurale o non numerabile: I like cats (i gatti in generale), non I like the cats; water is essential for life (l'acqua in generale, non un bicchiere specifico). Questo si contrappone a a/an (un esempio) e a the (uno specifico e già noto) — lo zero article parla di un'intera categoria, non di un singolo membro di essa.",
      {
    ...
    de: [
      "Benutze keinen Artikel — den sogenannten „Zero Article“ — für allgemeine Aussagen mit einem Plural- oder nicht zählbaren Nomen: I like cats (Katzen im Allgemeinen), nicht I like the cats; water is essential for life (Wasser im Allgemeinen, nicht ein bestimmtes Glas davon). Das steht im Gegensatz zu a/an (ein Beispiel) und the (ein bestimmtes, bekanntes) — der Zero Article spricht über eine ganze Kategorie, nicht über ein einzelnes Mitglied davon.",
      {
    ...
    ru: [
      "Используйте отсутствие артикля — так называемый «нулевой артикль» — для общих утверждений с существительным во множественном числе или неисчисляемым: I like cats (кошки вообще), а не I like the cats; water is essential for life (вода вообще, а не конкретный стакан воды). Это отличается от a/an (один пример) и the (конкретный, уже известный) — нулевой артикль говорит о целой категории, а не об одном её представителе.",
      {
    ...
    ar: [
      "استخدم غياب الأداة — ما يُسمى «zero article» — في العبارات العامة مع اسم جمع أو غير معدود: I like cats (القطط عمومًا)، وليس I like the cats؛ water is essential for life (الماء عمومًا، لا كوب محدد منه). ويختلف هذا عن a/an (مثال واحد) وعن the (شيء محدد ومعروف) — إذ يتحدث الـ zero article عن فئة كاملة، لا عن عضو واحد منها.",
      {
    ...
    zh: [
      "对复数或不可数名词的一般性陈述,要使用「零冠词」(不加任何冠词):I like cats(泛指猫),而不是 I like the cats;water is essential for life(泛指水,而不是某一杯具体的水)。这与 a/an(一个例子)和 the(一个特指的、已知的)不同——零冠词说的是整个类别,而不是其中的某一个成员。",
      {
        intro: "其他常见的零冠词情况:",
        items: [
  ...
  exercises: [
    {
      title: "Zero Article: General Statements & Proper Nouns",
      questions: [
        { sentence: "In general, ___ dogs are loyal animals.", answer: "no article", options: ["the", "a", "no article"], explanation: "a general statement about a whole category → no article, not the dogs.", explanationI18n: { fr: "une déclaration générale sur toute une catégorie → no article, pas the dogs.", es: "una afirmación general sobre toda una categoría → no article, no the dogs.", pt: "uma afirmação geral sobre toda uma categoria → no article, não the dogs.", it: "un'affermazione generale su un'intera categoria → no article, non the dogs.", de: "eine allgemeine Aussage über eine ganze Kategorie → no article, nicht the dogs.", ru: "общее утверждение о целой категории → no article, а не the dogs.", ar: "عبارة عامة عن فئة كاملة → no article، وليس the dogs.", zh: "关于整个类别的一般性陈述 → no article,而不是 the dogs。" } },
        { sentence: "In general, ___ water is essential for life.", answer: "no article", options: ["the", "a", "no article"], explanation: "an uncountable noun in general → no article.", explanationI18n: { fr: "un nom indénombrable au sens général → no article.", es: "un sustantivo incontable en sentido general → no article.", pt: "um substantivo incontável em sentido geral → no article.", it: "un nome non numerabile in senso generale → no article.", de: "ein nicht zählbares Nomen im allgemeinen Sinn → no article.", ru: "неисчисляемое существительное в общем значении → no article.", ar: "اسم غير معدود بالمعنى العام → no article.", zh: "泛指的不可数名词 → no article。" } },
        { sentence: "She lives in ___ France.", answer: "no article", options: ["the", "a", "no article"], explanation: "most country names take no article.", explanationI18n: { fr: "la plupart des noms de pays → no article.", es: "la mayoría de los nombres de países → no article.", pt: "a maioria dos nomes de países → no article.", it: "la maggior parte dei nomi di paesi → no article.", de: "die meisten Ländernamen → no article.", ru: "большинство названий стран → no article.", ar: "معظم أسماء البلدان → no article.", zh: "大多数国家名称 → no article。" } },
        { sentence: "He visited ___ Mount Everest last year.", answer: "no article", options: ["the", "a", "no article"], explanation: "most proper nouns (mountains, named places) take no article.", explanationI18n: { fr: "la plupart des noms propres (montagnes, lieux nommés) → no article.", es: "la mayoría de los nombres propios (montañas, lugares con nombre) → no article.", pt: "a maioria dos nomes próprios (montanhas, lugares com nome) → no article.", it: "la maggior parte dei nomi propri (montagne, luoghi con nome) → no article.", de: "die meisten Eigennamen (Berge, benannte Orte) → no article.", ru: "большинство имён собственных (горы, названные места) → no article.", ar: "معظم أسماء الأعلام (الجبال والأماكن المسمّاة) → no article.", zh: "大多数专有名词(山脉、有名称的地方)→ no article。" } },
        { sentence: "They live in ___ United States.", answer: "the", options: ["the", "a", "no article"], explanation: "country names with 'of' or plural-form names take the — an exception to the usual proper-noun rule.", explanationI18n: { fr: "les noms de pays avec of ou les noms au pluriel prennent the — une exception à la règle habituelle des noms propres.", es: "los nombres de países con of o los nombres en plural llevan the — una excepción a la regla habitual de los nombres propios.", pt: "os nomes de países com of ou os nomes no plural levam the — uma exceção à regra habitual dos nomes próprios.", it: "i nomi di paesi con of o i nomi al plurale prendono the — un'eccezione alla solita regola dei nomi propri.", de: "Ländernamen mit of oder Namen im Plural nehmen the — eine Ausnahme von der üblichen Eigennamen-Regel.", ru: "названия стран с of или названия во множественном числе принимают the — исключение из обычного правила для имён собственных.", ar: "أسماء البلدان التي تحتوي على of أو الأسماء بصيغة الجمع تأخذ the — استثناء من قاعدة أسماء الأعلام المعتادة.", zh: "含 of 的国家名称或复数形式的名称用 the——这是专有名词一般规则的一个例外。" } },
        { sentence: "We had ___ breakfast at 8am.", answer: "no article", options: ["the", "a", "no article"], explanation: "meals take no article.", explanationI18n: { fr: "les noms de repas → no article.", es: "los nombres de comidas → no article.", pt: "os nomes de refeições → no article.", it: "i nomi dei pasti → no article.", de: "Mahlzeiten → no article.", ru: "названия приёмов пищи → no article.", ar: "أسماء الوجبات → no article.", zh: "餐食名称 → no article。" } },
        { sentence: "I speak ___ Spanish and English.", answer: "no article", options: ["the", "a", "no article"], explanation: "languages take no article.", explanationI18n: { fr: "les noms de langues → no article.", es: "los nombres de idiomas → no article.", pt: "os nomes de línguas → no article.", it: "i nomi delle lingue → no article.", de: "Sprachen → no article.", ru: "названия языков → no article.", ar: "أسماء اللغات → no article.", zh: "语言名称 → no article。" } },
        { sentence: "She goes to work by ___ car.", answer: "no article", options: ["the", "a", "no article"], explanation: "by + means of transport takes no article.", explanationI18n: { fr: "by + moyen de transport → no article.", es: "by + medio de transporte → no article.", pt: "by + meio de transporte → no article.", it: "by + mezzo di trasporto → no article.", de: "by + Verkehrsmittel → no article.", ru: "by + средство передвижения → no article.", ar: "by + وسيلة نقل → no article.", zh: "by + 交通工具 → no article。" } },
        { sentence: "I'll see you ___ next week.", answer: "no article", options: ["the", "a", "no article"], explanation: "next/last + time word takes no article.", explanationI18n: { fr: "next/last + mot de temps → no article.", es: "next/last + palabra de tiempo → no article.", pt: "next/last + palavra de tempo → no article.", it: "next/last + parola di tempo → no article.", de: "next/last + Zeitwort → no article.", ru: "next/last + слово, обозначающее время → no article.", ar: "next/last + كلمة زمنية → no article.", zh: "next/last + 时间词 → no article。" } },
        { sentence: "In poetry, ___ love is often described as powerful.", answer: "no article", options: ["the", "a", "no article"], explanation: "abstract/mass nouns in general statements take no article.", explanationI18n: { fr: "les noms abstraits/indénombrables dans des déclarations générales → no article.", es: "los sustantivos abstractos/incontables en afirmaciones generales → no article.", pt: "os substantivos abstratos/incontáveis em afirmações gerais → no article.", it: "i nomi astratti/non numerabili in affermazioni generali → no article.", de: "abstrakte/nicht zählbare Nomen in allgemeinen Aussagen → no article.", ru: "абстрактные/неисчисляемые существительные в общих утверждениях → no article.", ar: "الأسماء المجردة/غير المعدودة في العبارات العامة → no article.", zh: "一般性陈述中的抽象名词/不可数名词 → no article。" } },
      ],
    },
    {
      title: "Zero Article vs The vs A/An — Mixed Practice",
      questions: [
        { sentence: "I think ___ Paris is a beautiful city.", answer: "no article", options: ["the", "a", "no article"], explanation: "most city names take no article." },
        { sentence: "He bought ___ book yesterday.", answer: "a", options: ["the", "a", "no article"], explanation: "first mention, one example → a." },
        { sentence: "___ book he bought is a bestseller.", answer: "The", options: ["A", "An", "The"], explanation: "already mentioned, specific → the." },
        { sentence: "In general, ___ elephants are intelligent.", answer: "no article", options: ["the", "a", "no article"], explanation: "general statement, plural noun → no article." },
        { sentence: "Can you close ___ window, please?", answer: "the", options: ["a", "an", "the"], explanation: "obvious from the shared situation → the." },
        { sentence: "She's studying ___ medicine at university.", answer: "no article", options: ["the", "a", "no article"], explanation: "academic subjects in general take no article." },
        { sentence: "He's ___ doctor.", answer: "a", options: ["the", "a", "no article"], explanation: "one member of a general category (profession) → a." },
        { sentence: "We had ___ lunch together yesterday.", answer: "no article", options: ["the", "a", "no article"], explanation: "meals take no article.", explanationI18n: { fr: "les noms de repas → no article.", es: "los nombres de comidas → no article.", pt: "os nomes de refeições → no article.", it: "i nomi dei pasti → no article.", de: "Mahlzeiten → no article.", ru: "названия приёмов пищи → no article.", ar: "أسماء الوجبات → no article.", zh: "餐食名称 → no article。" } },
        { sentence: "I'll call you ___ next month.", answer: "no article", options: ["the", "a", "no article"], explanation: "next/last + time word takes no article.", explanationI18n: { fr: "next/last + mot de temps → no article.", es: "next/last + palabra de tiempo → no article.", pt: "next/last + palavra de tempo → no article.", it: "next/last + parola di tempo → no article.", de: "next/last + Zeitwort → no article.", ru: "next/last + слово, обозначающее время → no article.", ar: "next/last + كلمة زمنية → no article.", zh: "next/last + 时间词 → no article。" } },
        { sentence: "They travelled to Rome by ___ train.", answer: "no article", options: ["the", "a", "no article"], explanation: "by + means of transport takes no article.", explanationI18n: { fr: "by + moyen de transport → no article.", es: "by + medio de transporte → no article.", pt: "by + meio de transporte → no article.", it: "by + mezzo di trasporto → no article.", de: "by + Verkehrsmittel → no article.", ru: "by + средство передвижения → no article.", ar: "by + وسيلة نقل → no article.", zh: "by + 交通工具 → no article。" } },
      ],
    },
  ],
};
