...
export const prepositionsOfTransport: GrammarTopicContent = {
  slug: "prepositions-of-transport",
  sectionSlug: "prepositions",
  title: "Prepositions with Transport: In, On & At",
  level: "A2",
  explanations: {
    en: [
      ...
      "The most common mistake is using in with large public vehicles — in the bus, in the train, in the plane sound unnatural; use on: on the bus, on the train, on the plane. A second mistake is confusing at (a location) with in/on (the vehicle) — I was in the bus stop is wrong; a stop or station is a place, so it takes at: I was at the bus stop.",
    ...
    fr: [
      ...
      "L'erreur la plus fréquente est d'employer in avec de grands véhicules publics — in the bus, in the train, in the plane sonnent bizarrement ; employez on : on the bus, on the train, on the plane. Une deuxième erreur est de confondre at (un lieu) avec in/on (le véhicule) — I was in the bus stop est incorrect ; un arrêt ou une gare est un lieu, donc il prend at : I was at the bus stop.",
    ...
    es: [
      ...
      "El error más común es usar in con vehículos públicos grandes —in the bus, in the train, in the plane suenan raro; usa on: on the bus, on the train, on the plane. Un segundo error es confundir at (un lugar) con in/on (el vehículo) —I was in the bus stop es incorrecto; una parada o estación es un lugar, así que lleva at: I was at the bus stop.",
    ...
    pt: [
      ...
      "O erro mais comum é usar in com veículos públicos maiores —in the bus, in the train, in the plane soam estranho; usa on: on the bus, on the train, on the plane. Um segundo erro é confundir at (um local) com in/on (o veículo) —I was in the bus stop está errado; uma paragem ou estação é um local, por isso leva at: I was at the bus stop.",
    ...
    it: [
      ...
      "L'errore più comune è usare in con grandi veicoli pubblici — in the bus, in the train, in the plane suonano innaturali; usa on: on the bus, on the train, on the plane. Un secondo errore è confondere at (un luogo) con in/on (il veicolo) — I was in the bus stop è sbagliato; una fermata o una stazione è un luogo, quindi richiede at: I was at the bus stop.",
    ...
    de: [
      ...
      "Der häufigste Fehler ist, in mit großen öffentlichen Verkehrsmitteln zu benutzen — in the bus, in the train, in the plane klingen unnatürlich; benutze on: on the bus, on the train, on the plane. Ein zweiter Fehler ist, at (ein Ort) mit in/on (das Fahrzeug) zu verwechseln — I was in the bus stop ist falsch; eine Haltestelle oder ein Bahnhof ist ein Ort, also braucht es at: I was at the bus stop.",
    ...
    ru: [
      ...
      "Самая частая ошибка — использовать in с крупными общественными транспортными средствами: in the bus, in the train, in the plane звучат неестественно; используйте on: on the bus, on the train, on the plane. Вторая ошибка — путать at (место) с in/on (транспорт): I was in the bus stop неверно; остановка или станция — это место, поэтому используется at: I was at the bus stop.",
    ...
    ar: [
      ...
      "أكثر الأخطاء شيوعًا هو استخدام in مع وسائل النقل العامة الكبيرة — تبدو in the bus وin the train وin the plane غير طبيعية؛ استخدم on: on the bus, on the train, on the plane. وخطأ ثانٍ هو الخلط بين at (مكان) وin/on (المركبة) — I was in the bus stop خطأ؛ فالمحطة أو الموقف مكان، لذا يأخذ at: I was at the bus stop.",
    ...
    zh: [
      ...
      "最常见的错误是把 in 用在大型公共交通工具上——in the bus, in the train, in the plane 听起来不自然;应该用 on:on the bus, on the train, on the plane。第二个常见错误是把 at(地点)和 in/on(交通工具)搞混——I was in the bus stop 是错误的;车站或站台是一个地点,所以要用 at:I was at the bus stop。",
      "问问自己你指的是小型私人交通工具(用 in),还是较大的公共交通工具或骑乘型交通工具(用 on),还是像车站或站台这样与交通相关的地点(用 at)。如果可以在里面走动或坐在上面,用 on;如果又小又封闭,用 in;如果指的是与交通相关的地点而不是交通工具本身,用 at。",
    ],
  },
  ...
  exercises: [
    {
      title: "In, On or At?",
      questions: [
        { sentence: "We travelled ___ a taxi to the hotel.", answer: "in", options: ["in", "on", "at"], explanation: "a taxi is a small, enclosed vehicle — in.", explanationI18n: { fr: "a taxi est un petit véhicule fermé — in.", es: "a taxi es un vehículo pequeño y cerrado — in.", pt: "a taxi é um veículo pequeno e fechado — in.", it: "a taxi è un veicolo piccolo e chiuso — in.", de: "a taxi ist ein kleines, geschlossenes Fahrzeug — in.", ru: "a taxi — маленькое, закрытое транспортное средство — in.", ar: "a taxi مركبة صغيرة ومغلقة — in.", zh: "a taxi 是狭小、封闭的交通工具——用 in。" } },
        { sentence: "She fell asleep ___ the train.", answer: "on", options: ["on", "in", "at"], explanation: "a train is a larger vehicle you can walk around in — on.", explanationI18n: { fr: "a train est un véhicule plus grand où l'on peut marcher à l'intérieur — on.", es: "a train es un vehículo más grande en el que puedes caminar dentro — on.", pt: "a train é um veículo maior onde podes caminhar lá dentro — on.", it: "a train è un veicolo più grande in cui si può camminare — on.", de: "a train ist ein größeres Fahrzeug, in dem man herumlaufen kann — on.", ru: "a train — более крупное транспортное средство, внутри которого можно ходить — on.", ar: "a train مركبة أكبر يمكنك التجول بداخلها — on.", zh: "a train 是可以在里面走动的较大交通工具——用 on。" } },
        { sentence: "They waited ___ the bus stop for twenty minutes.", answer: "at", options: ["at", "on", "in"], explanation: "a bus stop is a location, not the vehicle — at.", explanationI18n: { fr: "a bus stop est un lieu, pas le véhicule — at.", es: "a bus stop es un lugar, no el vehículo — at.", pt: "a bus stop é um local, não o veículo — at.", it: "a bus stop è un luogo, non il veicolo — at.", de: "a bus stop ist ein Ort, nicht das Fahrzeug — at.", ru: "a bus stop — это место, а не транспортное средство — at.", ar: "a bus stop مكان، لا المركبة — at.", zh: "a bus stop 是地点,而不是交通工具——用 at。" } },
        { sentence: "He got ___ the car and drove away.", answer: "in", options: ["in", "on", "at"], explanation: "a car is a small, enclosed vehicle — in.", explanationI18n: { fr: "a car est un petit véhicule fermé — in.", es: "a car es un vehículo pequeño y cerrado — in.", pt: "a car é um veículo pequeno e fechado — in.", it: "a car è un veicolo piccolo e chiuso — in.", de: "a car ist ein kleines, geschlossenes Fahrzeug — in.", ru: "a car — маленькое, закрытое транспортное средство — in.", ar: "a car مركبة صغيرة ومغلقة — in.", zh: "a car 是狭小、封闭的交通工具——用 in。" } },
        { sentence: "I always read a book ___ the plane.", answer: "on", options: ["on", "in", "at"], explanation: "a plane is a larger vehicle you can walk around in — on.", explanationI18n: { fr: "a plane est un véhicule plus grand où l'on peut marcher à l'intérieur — on.", es: "a plane es un vehículo más grande en el que puedes caminar dentro — on.", pt: "a plane é um veículo maior onde podes caminhar lá dentro — on.", it: "a plane è un veicolo più grande in cui si può camminare — on.", de: "a plane ist ein größeres Fahrzeug, in dem man herumlaufen kann — on.", ru: "a plane — более крупное транспортное средство, внутри которого можно ходить — on.", ar: "a plane مركبة أكبر يمكنك التجول بداخلها — on.", zh: "a plane 是可以在里面走动的较大交通工具——用 on。" } },
        { sentence: "We met ___ the station before the trip.", answer: "at", options: ["at", "on", "in"], explanation: "a station is a location, not the vehicle — at.", explanationI18n: { fr: "a station est un lieu, pas le véhicule — at.", es: "a station es un lugar, no el vehículo — at.", pt: "a station é um local, não o veículo — at.", it: "a station è un luogo, non il veicolo — at.", de: "a station ist ein Ort, nicht das Fahrzeug — at.", ru: "a station — это место, а не транспортное средство — at.", ar: "a station مكان، لا المركبة — at.", zh: "a station 是地点,而不是交通工具——用 at。" } },
        { sentence: "She rides ___ her bike to school every day.", answer: "on", options: ["on", "in", "at"], explanation: "a bike is ridden astride — on.", explanationI18n: { fr: "a bike se chevauche — on.", es: "a bike se monta a horcajadas — on.", pt: "a bike monta-se — on.", it: "a bike si cavalca — on.", de: "a bike wird rittlings bestiegen — on.", ru: "a bike «оседлывают» — on.", ar: "a bike تُمتطى — on.", zh: "a bike 是骑乘型的——用 on。" } },
        { sentence: "Please get ___ the taxi, it's waiting outside.", answer: "in", options: ["in", "on", "at"], explanation: "a taxi is a small, enclosed vehicle — in.", explanationI18n: { fr: "a taxi est un petit véhicule fermé — in.", es: "a taxi es un vehículo pequeño y cerrado — in.", pt: "a taxi é um veículo pequeno e fechado — in.", it: "a taxi è un veicolo piccolo e chiuso — in.", de: "a taxi ist ein kleines, geschlossenes Fahrzeug — in.", ru: "a taxi — маленькое, закрытое транспортное средство — in.", ar: "a taxi مركبة صغيرة ومغلقة — in.", zh: "a taxi 是狭小、封闭的交通工具——用 in。" } },
        { sentence: "He was ___ the bus when the accident happened.", answer: "on", options: ["on", "in", "at"], explanation: "a bus is a larger vehicle you can walk around in — on.", explanationI18n: { fr: "a bus est un véhicule plus grand où l'on peut marcher à l'intérieur — on.", es: "a bus es un vehículo más grande en el que puedes caminar dentro — on.", pt: "a bus é um veículo maior onde podes caminhar lá dentro — on.", it: "a bus è un veicolo più grande in cui si può camminare — on.", de: "a bus ist ein größeres Fahrzeug, in dem man herumlaufen kann — on.", ru: "a bus — более крупное транспортное средство, внутри которого можно ходить — on.", ar: "a bus مركبة أكبر يمكنك التجول بداخلها — on.", zh: "a bus 是可以在里面走动的较大交通工具——用 on。" } },
        { sentence: "I'll see you ___ the airport tomorrow.", answer: "at", options: ["at", "on", "in"], explanation: "an airport is a location, not the vehicle — at.", explanationI18n: { fr: "an airport est un lieu, pas le véhicule — at.", es: "an airport es un lugar, no el vehículo — at.", pt: "an airport é um local, não o veículo — at.", it: "an airport è un luogo, non il veicolo — at.", de: "an airport ist ein Ort, nicht das Fahrzeug — at.", ru: "an airport — это место, а не транспортное средство — at.", ar: "an airport مكان، لا المركبة — at.", zh: "an airport 是地点,而不是交通工具——用 at。" } },
      ],
    },
    {
      title: "Mixed Practice",
      questions: [
        { sentence: "We got ___ the train just before it left the station.", answer: "on", options: ["on", "in", "at"], explanation: "a train is a larger vehicle you can walk around in — on.", explanationI18n: { fr: "a train est un véhicule plus grand où l'on peut marcher à l'intérieur — on.", es: "a train es un vehículo más grande en el que puedes caminar dentro — on.", pt: "a train é um veículo maior onde podes caminhar lá dentro — on.", it: "a train è un veicolo più grande in cui si può camminare — on.", de: "a train ist ein größeres Fahrzeug, in dem man herumlaufen kann — on.", ru: "a train — более крупное транспортное средство, внутри которого можно ходить — on.", ar: "a train مركبة أكبر يمكنك التجول بداخلها — on.", zh: "a train 是可以在里面走动的较大交通工具——用 on。" } },
        { sentence: "Can you pick me up ___ the taxi rank?", answer: "at", options: ["at", "on", "in"], explanation: "a taxi rank is a location, not the vehicle — at.", explanationI18n: { fr: "a taxi rank est un lieu, pas le véhicule — at.", es: "a taxi rank es un lugar, no el vehículo — at.", pt: "a taxi rank é um local, não o veículo — at.", it: "a taxi rank è un luogo, non il veicolo — at.", de: "a taxi rank ist ein Ort, nicht das Fahrzeug — at.", ru: "a taxi rank — это место, а не транспортное средство — at.", ar: "a taxi rank مكان، لا المركبة — at.", zh: "a taxi rank 是地点,而不是交通工具——用 at。" } },
        { sentence: "She got ___ the car and locked the doors.", answer: "in", options: ["in", "on", "at"], explanation: "a car is a small, enclosed vehicle — in.", explanationI18n: { fr: "a car est un petit véhicule fermé — in.", es: "a car es un vehículo pequeño y cerrado — in.", pt: "a car é um veículo pequeno e fechado — in.", it: "a car è un veicolo piccolo e chiuso — in.", de: "a car ist ein kleines, geschlossenes Fahrzeug — in.", ru: "a car — маленькое, закрытое транспортное средство — in.", ar: "a car مركبة صغيرة ومغلقة — in.", zh: "a car 是狭小、封闭的交通工具——用 in。" } },
        { sentence: "They travelled ___ a ship across the Atlantic.", answer: "on", options: ["on", "in", "at"], explanation: "a ship is a larger vehicle you can walk around in — on.", explanationI18n: { fr: "a ship est un véhicule plus grand où l'on peut marcher à l'intérieur — on.", es: "a ship es un vehículo más grande en el que puedes caminar dentro — on.", pt: "a ship é um veículo maior onde podes caminhar lá dentro — on.", it: "a ship è un veicolo più grande in cui si può camminare — on.", de: "a ship ist ein größeres Fahrzeug, in dem man herumlaufen kann — on.", ru: "a ship — более крупное транспортное средство, внутри которого можно ходить — on.", ar: "a ship مركبة أكبر يمكنك التجول بداخلها — on.", zh: "a ship 是可以在里面走动的较大交通工具——用 on。" } },
        { sentence: "We waited ___ the platform for the next train.", answer: "at", options: ["at", "on", "in"], explanation: "a platform is a location, not the vehicle — at.", explanationI18n: { fr: "a platform est un lieu, pas le véhicule — at.", es: "a platform es un lugar, no el vehículo — at.", pt: "a platform é um local, não o veículo — at.", it: "a platform è un luogo, non il veicolo — at.", de: "a platform ist ein Ort, nicht das Fahrzeug — at.", ru: "a platform — это место, а не транспортное средство — at.", ar: "a platform مكان، لا المركبة — at.", zh: "a platform 是地点,而不是交通工具——用 at。" } },
        { sentence: "He was ___ a taxi when he called me.", answer: "in", options: ["in", "on", "at"], explanation: "a taxi is a small, enclosed vehicle — in.", explanationI18n: { fr: "a taxi est un petit véhicule fermé — in.", es: "a taxi es un vehículo pequeño y cerrado — in.", pt: "a taxi é um veículo pequeno e fechado — in.", it: "a taxi è un veicolo piccolo e chiuso — in.", de: "a taxi ist ein kleines, geschlossenes Fahrzeug — in.", ru: "a taxi — маленькое, закрытое транспортное средство — in.", ar: "a taxi مركبة صغيرة ومغلقة — in.", zh: "a taxi 是狭小、封闭的交通工具——用 in。" } },
        { sentence: "I saw her ___ the underground this morning.", answer: "on", options: ["on", "in", "at"], explanation: "the underground is a larger vehicle you can walk around in — on.", explanationI18n: { fr: "the underground est un véhicule plus grand où l'on peut marcher à l'intérieur — on.", es: "the underground es un vehículo más grande en el que puedes caminar dentro — on.", pt: "the underground é um veículo maior onde podes caminhar lá dentro — on.", it: "the underground è un veicolo più grande in cui si può camminare — on.", de: "the underground ist ein größeres Fahrzeug, in dem man herumlaufen kann — on.", ru: "the underground — более крупное транспортное средство, внутри которого можно ходить — on.", ar: "the underground مركبة أكبر يمكنك التجول بداخلها — on.", zh: "the underground 是可以在里面走动的较大交通工具——用 on。" } },
        { sentence: "Let's meet ___ the bus station at nine.", answer: "at", options: ["at", "on", "in"], explanation: "a bus station is a location, not the vehicle — at.", explanationI18n: { fr: "a bus station est un lieu, pas le véhicule — at.", es: "a bus station es un lugar, no el vehículo — at.", pt: "a bus station é um local, não o veículo — at.", it: "a bus station è un luogo, non il veicolo — at.", de: "a bus station ist ein Ort, nicht das Fahrzeug — at.", ru: "a bus station — это место, а не транспортное средство — at.", ar: "a bus station مكان، لا المركبة — at.", zh: "a bus station 是地点,而不是交通工具——用 at。" } },
        { sentence: "He rode ___ his motorbike to work.", answer: "on", options: ["on", "in", "at"], explanation: "a motorbike is ridden astride — on.", explanationI18n: { fr: "a motorbike se chevauche — on.", es: "a motorbike se monta a horcajadas — on.", pt: "a motorbike monta-se — on.", it: "a motorbike si cavalca — on.", de: "a motorbike wird rittlings bestiegen — on.", ru: "a motorbike «оседлывают» — on.", ar: "a motorbike تُمتطى — on.", zh: "a motorbike 是骑乘型的——用 on。" } },
        { sentence: "Get ___ the car quickly, we're going to be late!", answer: "in", options: ["in", "on", "at"], explanation: "a car is a small, enclosed vehicle — in.", explanationI18n: { fr: "a car est un petit véhicule fermé — in.", es: "a car es un vehículo pequeño y cerrado — in.", pt: "a car é um veículo pequeno e fechado — in.", it: "a car è un veicolo piccolo e chiuso — in.", de: "a car ist ein kleines, geschlossenes Fahrzeug — in.", ru: "a car — маленькое, закрытое транспортное средство — in.", ar: "a car مركبة صغيرة ومغلقة — in.", zh: "a car 是狭小、封闭的交通工具——用 in。" } },
      ],
    },
  ],
};
