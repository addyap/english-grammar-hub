...
export const presentSimple: GrammarTopicContent = {
  ...
  explanations: {
    en: [
      ...
      "The most common mistake is forgetting -s with he/she/it — he live in Paris is wrong, it must be he lives in Paris. This slips even for speakers whose own language conjugates verbs fully for every person, because English does the opposite: it leaves I/you/we/they completely unmarked and only marks the 3rd person singular, so that one -s is easy to forget precisely because it's the exception, not the rule. Do and does are also easy to misuse: they carry no meaning of their own and only appear in negatives and questions, so the main verb stays in its base form after them — she doesn't play tennis, not she doesn't plays.",
    ...
    pt: [
      ...
      "O erro mais comum é esquecer o -s com he/she/it: he live in Paris está errado, o correto é he lives in Paris. Este erro afeta até falantes cuja língua conjuga plenamente os verbos em cada pessoa, porque o inglês faz o oposto: não marca I/you/we/they de forma alguma e só marca a terceira pessoa do singular, por isso esse único -s é fácil de esquecer justamente por ser a exceção, não a regra. Do e does também são fonte de erros: não têm significado próprio e só aparecem em negações e perguntas, por isso o verbo principal permanece na forma base depois deles: she doesn't play tennis, e não she doesn't plays.",
    ...
    ru: [
      ...
      "Самая частая ошибка — забыть -s с he/she/it: he live in Paris неправильно, нужно he lives in Paris. Эта ошибка встречается даже у тех, чей язык полностью спрягает глаголы по лицам, потому что английский делает наоборот: он вообще не маркирует I/you/we/they и маркирует только 3-е лицо единственного числа, поэтому именно это -s легко забыть — как раз потому, что это исключение, а не правило. Do и does тоже часто используют неправильно: у них нет собственного значения, и они появляются только в отрицаниях и вопросах, поэтому основной глагол после них остаётся в базовой форме: she doesn't play tennis, а не she doesn't plays.",
    ...
    zh: [
      ...
      "最常见的错误是忘记给 he/she/it 加 -s:he live in Paris 是错的,应该是 he lives in Paris。即使是母语中每个人称都要完整变位的学习者,也常犯这个错误,因为英语正好相反:I/you/we/they 完全不变化,只有第三人称单数才变化,所以这唯一的 -s 反而最容易被忘记——正因为它是例外,而不是规则。do 和 does 也容易用错:它们本身没有意义,只出现在否定句和疑问句中,因此它们后面的主要动词要保持原形:she doesn't play tennis,而不是 she doesn't plays。",
