  ...
  exercises: [
    {
      ...
      questions: [
        ...
        { sentence: "Company policy says all visitors ___ (sign) in at reception.", answer: "have to sign", options: ["have to sign", "has to sign", "musted sign"], explanation: "have to suits an external rule like company policy (must sign is also possible here, especially on formal signage). The other two are impossible forms: visitors is plural, so has to cannot agree with it, and musted does not exist." },
        { sentence: "I really ___ (call) her back — it's been bothering me all day.", answer: "must call", options: ["must call", "must to call", "had to call"], explanation: "must fits the speaker's own sense of urgency ('it's been bothering me'); have to would also be acceptable here, which is why it is not offered. must to is never possible — a modal takes a bare base verb — and had to is past, clashing with the ongoing present." },
        ...
        { sentence: "My visa requires that I ___ (leave) the country before it expires.", answer: "have to leave", options: ["have to leave", "has to leave", "musted leave"], explanation: "have to suits an external requirement like a visa rule (must leave is also possible). The other two are impossible: the subject is I, which never takes has to, and musted does not exist." },
        ...
        { sentence: "I insist that I ___ (apologize) to her myself — it matters to me.", answer: "must apologize", options: ["must apologize", "must to apologize", "had to apologize"], explanation: "must matches the speaker's own insistence; have to would also work, so it is not offered as a wrong answer. must to is never possible, and had to is past, clashing with 'it matters to me'." },
        { sentence: "The law requires that all drivers ___ (carry) valid insurance.", answer: "have to carry", options: ["have to carry", "has to carry", "musted carry"], explanation: "have to suits a legal requirement (must carry is also correct English here). The others are impossible: drivers is plural, so has to cannot agree, and musted does not exist." },
    ...
    },
    {
      ...
      questions: [
        ...
        { sentence: "Company policy says employees ___ (complete) the training before they start work.", answer: "have to complete", options: ["have to complete", "has to complete", "musted complete"], explanation: "have to suits an external policy (must complete is also possible). employees is plural, so has to cannot agree with it, and musted does not exist." },
        { sentence: "I feel like I really ___ (tell) him the truth — I can't keep this secret any longer.", answer: "must tell", options: ["must tell", "must to tell", "had to tell"], explanation: "must matches the speaker's own feeling ('I feel like I really...'); have to is also acceptable, so it is not offered. must to is never possible, and had to is past, clashing with the present 'I can't keep this secret'." },
        ...
        { sentence: "The airline's rules mean all passengers ___ (check) in two hours before departure.", answer: "have to check", options: ["have to check", "has to check", "musted check"], explanation: "have to suits an external rule set by the airline (must check is also possible). passengers is plural, so has to cannot agree, and musted does not exist." },
        ...
        { sentence: "I insist that we ___ (thank) her properly — it really matters to me.", answer: "must thank", options: ["must thank", "must to thank", "had to thank"], explanation: "must matches the speaker's own insistence; have to would also be acceptable, so it is not a wrong answer here. must to is never possible, and had to is past, clashing with 'it really matters to me'." },
        { sentence: "Hospital regulations state that all staff ___ (wear) an ID badge at all times.", answer: "have to wear", options: ["have to wear", "must to wear", "musted wear"], explanation: "have to suits an external regulation (must wear is also correct here, which is why it is not offered as a wrong answer). must to and musted are both impossible forms." },
      ],
    },
  ],
};
