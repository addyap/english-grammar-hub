  ...
  exercises: [
    {
      ...
      questions: [
        ...
        { sentence: "He ___ (not/listen) to music.", answer: "isn't listening", options: ["isn't listening", "aren't listening", "doesn't listen"], explanation: "Negative: is + not + verb-ing.", explanationI18n: { fr: "Forme négative : is + not + verb-ing.", es: "Negativo: is + not + verb-ing.", pt: "Negativa: is + not + verb-ing.", it: "Negativo: is + not + verb-ing.", de: "Verneinung: is + not + verb-ing.", ru: "Отрицание: is + not + verb-ing.", ar: "النفي: is + not + verb-ing.", zh: "否定式:is + not + verb-ing。" } },
