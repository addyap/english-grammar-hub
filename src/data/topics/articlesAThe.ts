...
export const articlesAThe: GrammarTopicContent = {
  ...
  explanations: {
    en: [
      ...
      "Form: a before a consonant sound, an before a vowel sound — the sound matters, not the letter: Say a university and a European city, because both start with a consonant sound, 'yoo'. But say an hour (the h is silent, so the word starts with a vowel sound) and an MBA (M is pronounced 'em', which starts with a vowel sound even though the letter itself isn't silent). The is the same spelling for singular and plural, and for every noun.",
      {
        intro: "The signals a specific, identifiable thing in several common situations:",
        items: [
          "already mentioned: I bought a book. The book was expensive.",
          "unique / only one: the sun, the internet, the president (of a country, in context)",
          "made specific by extra information: the man in the blue coat, the capital of France",
    ...
    fr: [
      ...
      "Formation : a devant un son consonne, an devant un son voyelle — c'est le son qui compte, pas la lettre : On dit a university et a European city, car les deux commencent par un son consonne, « you ». Mais on dit an hour (le h est muet, donc le mot commence par un son voyelle) et an MBA (le M se prononce « em », qui commence par un son voyelle même si la lettre elle-même n'est pas muette). The s'écrit de la même façon au singulier et au pluriel, pour tous les noms.",
      {
        intro: "The signale quelque chose de précis et identifiable dans plusieurs situations courantes :",
        items: [
          "déjà mentionné : I bought a book. The book was expensive.",
          "unique / il n'y en a qu'un : the sun, the internet, the president (d'un pays, selon le contexte)",
          "rendu précis par une information supplémentaire : the man in the blue coat, the capital of France",
    ...
    es: [
      ...
      "Forma: a delante de un sonido consonántico, an delante de un sonido vocálico — importa el sonido, no la letra: Se dice a university y a European city, porque ambas empiezan con sonido consonántico, «yu». Pero se dice an hour (la h es muda, así que la palabra empieza con sonido vocálico) y an MBA (la M se pronuncia «em», que empieza con sonido vocálico aunque la letra en sí no sea muda). The se escribe igual en singular y en plural, y con cualquier sustantivo.",
      {
        intro: "The señala algo concreto e identificable en varias situaciones habituales:",
        items: [
          "ya mencionado: I bought a book. The book was expensive.",
          "único / solo hay uno: the sun, the internet, the president (de un país, según el contexto)",
          "hecho concreto por información adicional: the man in the blue coat, the capital of France",
    ...
    pt: [
      ...
      "Forma: a antes de um som consoante, an antes de um som vogal — o que importa é o som, não a letra: Diz-se a university e a European city, porque ambas começam com som consoante, «iu». Mas diz-se an hour (o h é mudo, por isso a palavra começa com som vogal) e an MBA (o M pronuncia-se «em», que começa com som vogal, mesmo que a letra em si não seja muda). The escreve-se da mesma forma no singular e no plural, e com qualquer substantivo.",
      {
        intro: "The assinala algo específico e identificável em várias situações comuns:",
        items: [
          "já mencionado: I bought a book. The book was expensive.",
          "único / só há um: the sun, the internet, the president (de um país, consoante o contexto)",
          "tornado específico por informação adicional: the man in the blue coat, the capital of France",
    ...
    it: [
      ...
      "Forma: a davanti a un suono consonantico, an davanti a un suono vocalico — conta il suono, non la lettera: Si dice a university e a European city, perché entrambe iniziano con un suono consonantico, «iu». Ma si dice an hour (la h è muta, quindi la parola inizia con un suono vocalico) e an MBA (la M si pronuncia «em», che inizia con un suono vocalico anche se la lettera in sé non è muta). The si scrive allo stesso modo al singolare e al plurale, e con qualsiasi nome.",
      {
        intro: "The segnala qualcosa di specifico e identificabile in diverse situazioni comuni:",
        items: [
          "già menzionato: I bought a book. The book was expensive.",
          "unico / ce n'è solo uno: the sun, the internet, the president (di un paese, a seconda del contesto)",
          "reso specifico da informazioni aggiuntive: the man in the blue coat, the capital of France",
    ...
    de: [
      ...
      "Form: a vor einem Konsonantenlaut, an vor einem Vokallaut — der Laut zählt, nicht der Buchstabe: Man sagt a university und a European city, denn beide beginnen mit einem Konsonantenlaut, „ju“. Aber man sagt an hour (das h ist stumm, daher beginnt das Wort mit einem Vokallaut) und an MBA (das M wird „em“ ausgesprochen, was mit einem Vokallaut beginnt, auch wenn der Buchstabe selbst nicht stumm ist). The wird im Singular und Plural gleich geschrieben, bei jedem Nomen.",
      {
        intro: "The signalisiert in mehreren häufigen Situationen etwas Bestimmtes, Identifizierbares:",
        items: [
          "bereits erwähnt: I bought a book. The book was expensive.",
          "einzigartig / es gibt nur eins: the sun, the internet, the president (eines Landes, je nach Kontext)",
          "durch zusätzliche Information konkretisiert: the man in the blue coat, the capital of France",
    ...
    ru: [
      ...
      "Форма: a перед согласным звуком, an перед гласным звуком — важен звук, а не буква: Говорят a university и a European city, потому что оба слова начинаются с согласного звука «ю». Но говорят an hour (буква h не произносится, поэтому слово начинается с гласного звука) и an MBA (буква M произносится как «эм», а это начинается с гласного звука, хотя сама буква не является немой). The пишется одинаково в единственном и множественном числе, с любым существительным.",
      {
        intro: "The указывает на что-то конкретное и узнаваемое в нескольких распространённых ситуациях:",
        items: [
          "уже упоминалось: I bought a book. The book was expensive.",
          "единственное в своём роде: the sun, the internet, the president (страны, в зависимости от контекста)",
          "стало конкретным благодаря дополнительной информации: the man in the blue coat, the capital of France",
    ...
    ar: [
      ...
      "الصيغة: a قبل صوت ساكن، an قبل صوت متحرك — الصوت هو ما يهم لا الحرف: نقول a university و a European city، لأن كلتيهما تبدآن بصوت ساكن «يو». لكن نقول an hour (الحرف h صامت، لذا تبدأ الكلمة بصوت متحرك) و an MBA (يُنطق الحرف M كـ «إم»، وهو ما يبدأ بصوت متحرك رغم أن الحرف نفسه ليس صامتًا). أما the فتُكتب بالشكل نفسه في المفرد والجمع، ومع أي اسم.",
      {
        intro: "تشير the إلى شيء محدد وقابل للتعرّف عليه في عدة مواقف شائعة:",
        items: [
          "ذُكر سابقًا: I bought a book. The book was expensive.",
          "فريد / لا يوجد سواه: the sun، the internet، the president (لدولة، حسب السياق)",
          "أصبح محددًا بفضل معلومة إضافية: the man in the blue coat، the capital of France",
    ...
    zh: [
      ...
      "构成:辅音音素前用 a,元音音素前用 an——重要的是发音,而不是字母:要说 a university 和 a European city,因为这两个词都以辅音音素「yu」开头。但要说 an hour(h 不发音,所以这个词以元音音素开头)和 an MBA(M 读作「em」,即使字母本身并非不发音,发音仍以元音音素开头)。the 的拼写在单数和复数、以及任何名词前都相同。",
      {
        intro: "the 在几种常见情况下表示具体、可识别的事物:",
        items: [
          "之前已经提到过:I bought a book. The book was expensive.",
          "独一无二/仅此一个:the sun、the internet、the president(某国的总统,视语境而定)",
          "因附加信息而变得具体:the man in the blue coat、the capital of France",
  ...
  exercises: [
    {
      title: "A vs An",
      questions: [
        { sentence: "She bought ___ umbrella.", answer: "an", options: ["a", "an", "the"], explanation: "umbrella starts with a vowel sound → an.", explanationI18n: { fr: "umbrella commence par un son voyelle → an.", es: "umbrella empieza con sonido vocálico → an.", pt: "umbrella começa com som vogal → an.", it: "umbrella inizia con un suono vocalico → an.", de: "umbrella beginnt mit einem Vokallaut → an.", ru: "umbrella начинается с гласного звука → an.", ar: "umbrella تبدأ بصوت متحرك → an.", zh: "umbrella 以元音音素开头 → an。" } },
        { sentence: "He's ___ university student.", answer: "a", options: ["a", "an", "the"], explanation: "university starts with a consonant sound ('yoo') → a.", explanationI18n: { fr: "university commence par un son consonne ('yoo') → a.", es: "university empieza con sonido consonántico ('yoo') → a.", pt: "university começa com som consoante ('yoo') → a.", it: "university inizia con un suono consonantico ('yoo') → a.", de: "university beginnt mit einem Konsonantenlaut ('yoo') → a.", ru: "university начинается с согласного звука ('yoo') → a.", ar: "university تبدأ بصوت ساكن ('yoo') → a.", zh: "university 以辅音音素('yoo')开头 → a。" } },
        { sentence: "I waited for ___ hour.", answer: "an", options: ["a", "an", "the"], explanation: "hour starts with a vowel sound — the h is silent → an.", explanationI18n: { fr: "hour commence par un son voyelle — le h est muet → an.", es: "hour empieza con sonido vocálico — la h es muda → an.", pt: "hour começa com som vogal — o h é mudo → an.", it: "hour inizia con un suono vocalico — la h è muta → an.", de: "hour beginnt mit einem Vokallaut — das h ist stumm → an.", ru: "hour начинается с гласного звука — h не произносится → an.", ar: "hour تبدأ بصوت متحرك — الحرف h صامت → an.", zh: "hour 以元音音素开头——h 不发音 → an。" } },
        { sentence: "They live in ___ old house.", answer: "an", options: ["a", "an", "the"], explanation: "old starts with a vowel sound → an.", explanationI18n: { fr: "old commence par un son voyelle → an.", es: "old empieza con sonido vocálico → an.", pt: "old começa com som vogal → an.", it: "old inizia con un suono vocalico → an.", de: "old beginnt mit einem Vokallaut → an.", ru: "old начинается с гласного звука → an.", ar: "old تبدأ بصوت متحرك → an.", zh: "old 以元音音素开头 → an。" } },
        { sentence: "She's ___ European diplomat.", answer: "a", options: ["a", "an", "the"], explanation: "European starts with a consonant sound ('yoo') → a.", explanationI18n: { fr: "European commence par un son consonne ('yoo') → a.", es: "European empieza con sonido consonántico ('yoo') → a.", pt: "European começa com som consoante ('yoo') → a.", it: "European inizia con un suono consonantico ('yoo') → a.", de: "European beginnt mit einem Konsonantenlaut ('yoo') → a.", ru: "European начинается с согласного звука ('yoo') → a.", ar: "European تبدأ بصوت ساكن ('yoo') → a.", zh: "European 以辅音音素('yoo')开头 → a。" } },
        { sentence: "He has ___ MBA from Harvard.", answer: "an", options: ["a", "an", "the"], explanation: "MBA starts with a vowel sound ('em') → an.", explanationI18n: { fr: "MBA commence par un son voyelle ('em') → an.", es: "MBA empieza con sonido vocálico ('em') → an.", pt: "MBA começa com som vogal ('em') → an.", it: "MBA inizia con un suono vocalico ('em') → an.", de: "MBA beginnt mit einem Vokallaut ('em') → an.", ru: "MBA начинается с гласного звука ('em') → an.", ar: "MBA تبدأ بصوت متحرك ('em') → an.", zh: "MBA 以元音音素('em')开头 → an。" } },
        { sentence: "We saw ___ eagle in the sky.", answer: "an", options: ["a", "an", "the"], explanation: "eagle starts with a vowel sound → an.", explanationI18n: { fr: "eagle commence par un son voyelle → an.", es: "eagle empieza con sonido vocálico → an.", pt: "eagle começa com som vogal → an.", it: "eagle inizia con un suono vocalico → an.", de: "eagle beginnt mit einem Vokallaut → an.", ru: "eagle начинается с гласного звука → an.", ar: "eagle تبدأ بصوت متحرك → an.", zh: "eagle 以元音音素开头 → an。" } },
        { sentence: "It was ___ one-hour delay.", answer: "a", options: ["a", "an", "the"], explanation: "one starts with a consonant sound ('wuh') → a.", explanationI18n: { fr: "one commence par un son consonne ('wuh') → a.", es: "one empieza con sonido consonántico ('wuh') → a.", pt: "one começa com som consoante ('wuh') → a.", it: "one inizia con un suono consonantico ('wuh') → a.", de: "one beginnt mit einem Konsonantenlaut ('wuh') → a.", ru: "one начинается с согласного звука ('wuh') → a.", ar: "one تبدأ بصوت ساكن ('wuh') → a.", zh: "one 以辅音音素('wuh')开头 → a。" } },
        { sentence: "She works as ___ nurse.", answer: "a", options: ["a", "an", "the"], explanation: "nurse starts with a consonant sound → a.", explanationI18n: { fr: "nurse commence par un son consonne → a.", es: "nurse empieza con sonido consonántico → a.", pt: "nurse começa com som consoante → a.", it: "nurse inizia con un suono consonantico → a.", de: "nurse beginnt mit einem Konsonantenlaut → a.", ru: "nurse начинается с согласного звука → a.", ar: "nurse تبدأ بصوت ساكن → a.", zh: "nurse 以辅音音素开头 → a。" } },
        { sentence: "He gave ___ honest answer.", answer: "an", options: ["a", "an", "the"], explanation: "honest starts with a vowel sound — the h is silent → an.", explanationI18n: { fr: "honest commence par un son voyelle — le h est muet → an.", es: "honest empieza con sonido vocálico — la h es muda → an.", pt: "honest começa com som vogal — o h é mudo → an.", it: "honest inizia con un suono vocalico — la h è muta → an.", de: "honest beginnt mit einem Vokallaut — das h ist stumm → an.", ru: "honest начинается с гласного звука — h не произносится → an.", ar: "honest تبدأ بصوت متحرك — الحرف h صامت → an.", zh: "honest 以元音音素开头——h 不发音 → an。" } },
      ],
    },
    {
      title: "A/An vs The",
      questions: [
        { sentence: "I saw ___ cat in the garden yesterday.", answer: "a", options: ["a", "an", "the"], explanation: "first mention → a.", explanationI18n: { fr: "première mention → a.", es: "primera mención → a.", pt: "primeira menção → a.", it: "prima menzione → a.", de: "erste Erwähnung → a.", ru: "первое упоминание → a.", ar: "الذكر الأول → a.", zh: "首次提及 → a。" } },
        { sentence: "___ cat I saw yesterday came back today.", answer: "The", options: ["A", "An", "The"], explanation: "already mentioned, now specific → the.", explanationI18n: { fr: "déjà mentionné, désormais précis → the.", es: "ya mencionado, ahora específico → the.", pt: "já mencionado, agora específico → the.", it: "già menzionato, ora specifico → the.", de: "schon erwähnt, jetzt konkret → the.", ru: "уже упомянуто, теперь конкретно → the.", ar: "ذُكر سابقًا، وأصبح الآن محددًا → the.", zh: "之前已提到,现在是特指 → the。" } },
        { sentence: "___ sun rises in the east.", answer: "The", options: ["A", "An", "The"], explanation: "unique — there's only one sun → the.", explanationI18n: { fr: "unique — il n'y a qu'un seul soleil → the.", es: "único — solo hay un sol → the.", pt: "único — só há um sol → the.", it: "unico — c'è un solo sole → the.", de: "einzigartig — es gibt nur eine Sonne → the.", ru: "единственное в своём роде — солнце только одно → the.", ar: "فريد — الشمس واحدة لا غير → the.", zh: "独一无二——太阳只有一个 → the。" } },
        { sentence: "She's ___ teacher at a local school.", answer: "a", options: ["a", "an", "the"], explanation: "one of many teachers, a general category → a.", explanationI18n: { fr: "une enseignante parmi tant d'autres, une catégorie générale → a.", es: "una profesora entre muchas, una categoría general → a.", pt: "uma professora entre muitas, uma categoria geral → a.", it: "un'insegnante tra tante, una categoria generale → a.", de: "eine Lehrerin unter vielen, eine allgemeine Kategorie → a.", ru: "одна из многих учительниц, общая категория → a.", ar: "معلمة من بين كثيرات، فئة عامة → a.", zh: "众多老师中的一位,泛指类别 → a。" } },
        { sentence: "Can you pass me ___ salt, please?", answer: "the", options: ["a", "an", "the"], explanation: "obvious from the shared situation (the salt on this table) → the.", explanationI18n: { fr: "évident d'après la situation partagée (le sel sur cette table) → the.", es: "obvio por la situación compartida (la sal de esta mesa) → the.", pt: "óbvio pela situação partilhada (o sal desta mesa) → the.", it: "ovvio dalla situazione condivisa (il sale su questo tavolo) → the.", de: "aus der gemeinsamen Situation offensichtlich (das Salz auf diesem Tisch) → the.", ru: "очевидно из общей ситуации (соль на этом столе) → the.", ar: "واضح من الموقف المشترك (الملح على هذه الطاولة) → the.", zh: "从共同的情境中显而易见(这张桌子上的盐) → the。" } },
        { sentence: "He bought ___ car last week.", answer: "a", options: ["a", "an", "the"], explanation: "first mention → a.", explanationI18n: { fr: "première mention → a.", es: "primera mención → a.", pt: "primeira menção → a.", it: "prima menzione → a.", de: "erste Erwähnung → a.", ru: "первое упоминание → a.", ar: "الذكر الأول → a.", zh: "首次提及 → a。" } },
        { sentence: "___ car he bought is red.", answer: "The", options: ["A", "An", "The"], explanation: "already specific, already mentioned → the.", explanationI18n: { fr: "déjà précis, déjà mentionné → the.", es: "ya específico, ya mencionado → the.", pt: "já específico, já mencionado → the.", it: "già specifico, già menzionato → the.", de: "schon konkret, schon erwähnt → the.", ru: "уже конкретно, уже упомянуто → the.", ar: "محدد سلفًا، وقد ذُكر من قبل → the.", zh: "已经特指,之前已提到 → the。" } },
        { sentence: "___ Eiffel Tower is in Paris.", answer: "The", options: ["A", "An", "The"], explanation: "unique landmark, only one → the.", explanationI18n: { fr: "monument unique, il n'y en a qu'un → the.", es: "monumento único, solo hay uno → the.", pt: "monumento único, só há um → the.", it: "monumento unico, ce n'è solo uno → the.", de: "einzigartiges Wahrzeichen, nur eines → the.", ru: "уникальная достопримечательность, только одна → the.", ar: "معلم فريد، لا يوجد سواه → the.", zh: "独一无二的地标,仅此一个 → the。" } },
        { sentence: "I need ___ pen — do you have one?", answer: "a", options: ["a", "an", "the"], explanation: "any pen, not a specific one → a.", explanationI18n: { fr: "n'importe quel stylo, pas un stylo précis → a.", es: "cualquier bolígrafo, no uno concreto → a.", pt: "qualquer caneta, não uma específica → a.", it: "una penna qualsiasi, non una specifica → a.", de: "irgendein Stift, kein bestimmter → a.", ru: "любая ручка, не какая-то конкретная → a.", ar: "أي قلم، وليس قلمًا محددًا → a.", zh: "任何一支笔,而非特定的某支 → a。" } },
        { sentence: "Where's ___ pen I lent you yesterday?", answer: "the", options: ["a", "an", "the"], explanation: "specific, already established → the.", explanationI18n: { fr: "précis, déjà établi → the.", es: "específico, ya establecido → the.", pt: "específico, já estabelecido → the.", it: "specifico, già stabilito → the.", de: "konkret, schon festgelegt → the.", ru: "конкретно, уже установлено → the.", ar: "محدد، وقد سبق تحديده → the.", zh: "特指,之前已确定 → the。" } },
      ],
    },
  ],
};
